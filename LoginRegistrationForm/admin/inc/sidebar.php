 <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <!--<li><a href="registerd_list.php"><i class="fa fa-circle-o"></i>Newly Registered</a></li>-->
       ...
       <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href=""><i class="fa fa-circle-o"></i>Step 0(Registered but <br/>Not Applied)</a></li>
            <li><a href="applied_job.php"><i class="fa fa-circle-o"></i>Step 1(All Applied People)</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i>Step 2(Applied but <br/> Not Completed Resume)</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i>Step 3(Seleted Candidate<br/> for Interview)</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i>Step 4(Will be <br/>Perticipating or Not)</a></li>
            <li><a href="reschedule.php"><i class="fa fa-circle-o"></i>Step 5(Rescheduled <br/>People List)</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i>Step 6</a></li>
